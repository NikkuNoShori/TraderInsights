...
UNION ALL
SELECT 
  'trades' AS table_name, COUNT(*) AS record_count 
FROM trades
UNION ALL
SELECT 
  'snaptrade_credentials' AS table_name, COUNT(*) AS record_count 
FROM snaptrade_credentials
UNION ALL
SELECT 
  'dashboard_profiles' AS table_name, COUNT(*) AS record_count 
FROM dashboard_profiles
UNION ALL
SELECT 
  'symbols_watched' AS table_name, COUNT(*) AS record_count 
